...
#            $convention.ContainerRegistries.Prod.ResourceGroupName = 'container-registry'
            ...
            if ($EnvironmentName -eq 'qa') {
                ...
                $convention.SubProducts.Api.Failover.ResourceLocation = $convention.SubProducts.Api.Primary.ResourceLocation
                $convention.SubProducts.App.Failover.ResourceLocation = $convention.SubProducts.App.Primary.ResourceLocation
            }
