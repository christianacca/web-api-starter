        ...
        try {
            ...
            $mainArmParams = @{
                ...
                TemplateParameterObject =   @{
                    additionalSqlFirewallRules  =   @($currentIpRule)
            ...
            Add-Summary 'Api Managed Identity Client Id' $armResources.apiManagedIdentityClientId.Value
            Add-Summary 'Function App Managed Identity Client Id' $armResources.functionAppManagedIdentityClientId.Value
            ...
            $dbCrudMembership = @(
                ...
                @{
                    ApplicationId       =   $armResources.functionAppManagedIdentityClientId.Value
                    Type                =   'ServicePrincipal'
                }
            )
